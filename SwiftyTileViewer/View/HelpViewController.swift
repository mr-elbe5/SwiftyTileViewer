...
class HelpViewController: NSViewController {
    ...
    let texts = ["Swifty Tile Viewer is a tool to identify and view map tiles like those of OpenStreetMap.",
                 "Although the default server is the OpenStreetMap tile server, this app is not endorsed by or affiliated with the OpenStreetMap Foundation.",
                 "The server can be changed in 'Preferences', where you enter a host address. For loading tiles, this address (which ends with a slash) will be completed with a pattern of 'z/x/y.png', where z is the zoom level and x and y the tile coordinates.",
                 ...
                 "In 'Preferences' you should also set an appropriate load timeout, which should correspond to the 'not found' timeout on your server.",
                 ...
                 "Especially you should not use the default server for such bulk operations!",
